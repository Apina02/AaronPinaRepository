...
class Program {
  ...
  {
    // Print the lyrics for Unit Test #1
   ...
   Console.WriteLine("And I can't help but to hear /");
    ...
    // Print the lyrics for Unit Test #2
    Console.WriteLine("Oh-oh-oh-oh-oh,");
    Console.WriteLine("oh-oh-oh-oh,");
    Console.WriteLine("oh-oh-oh /");
    Console.WriteLine("Caught in a bad romance.../n");
    Console.WriteLine(); // Add a blank line for separation

    // Print the lyrics for Unit Test #3
    ...
    // Print the lyrics for Unit Test #4
